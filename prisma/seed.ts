  ...
  for (const pkg of mockPackages) {
    const created = await prisma.package.upsert({
      ...
      update: {
        ...
        general: pkg.general as any,
        flights: pkg.flights as any,
        accommodations: pkg.accommodations as any,
        pricing: pkg.pricing as any,
        agencyCommissions: pkg.agencyCommissions as any,
        content: pkg.content as any,
  ...
  for (const booking of mockBookings) {
    await prisma.booking.upsert({
      ...
      update: {
        ...
        uploads: booking.uploads as any,
